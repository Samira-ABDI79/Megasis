...
<a href="/event/ekos-genesis-art-collection/">
<h2 className="text-2xl font-bold leading-tight text-black hover:text-indigo-700 dark:text-yellow-100 dark:hover:text-lime-200">{NFT.name}</h2>
</a>
...
{NFT.verified ?  <span className="px-1 text-sm font-medium text-black dark:text-lime-200">verified</span> : <></> }
</div>
</div>
...
<a href="/event/ekos-genesis-art-collection/" className="px-4 py-4 text-sm text-gray-800 bg-gray-200 rounded dark:bg-stone-900 dark:text-gray-200 md:py-3 md:px-5 hover:bg-gray-300 hover:text-black">
Read More
</a>
</div>
</div>
